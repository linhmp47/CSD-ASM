...
public class OperationToProduct {
    ...
    public String importId(Scanner console) {
        Console.print("Input Product's ID: ");
    ...
    public void writeFile(String filePath, MyList list) {
        try {
            ...
            Console.println("Save file successfully!");
            output.close();
            file.close();
        } catch (FileNotFoundException e) {
    ...
    public void deleteById(MyList list, String id) {
        ...
        Console.println("Delete product successfully!");
    }
    ...
    public void sortById(MyList list) {
        ...
        Console.println("Sort list successfully!");
    }
